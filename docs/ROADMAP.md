...
|-------|-------|------|--------------|----------|
| 1 | P13 | Calibration | **P13-S1 done** (`rai calibrate` suggest-only, `rai.config.json` loading). Next: P13-S2 evidence-correlated suggestions (observed+1 instead of current+1). | Trust. Kills noise first; every later phase inherits this quality. |
