...
|-------|-------|------|--------------|----------|
| 1 | P13 | Calibration | **P13-S1 done** (`rai calibrate` suggest-only, `rai.config.json` loading). **P13-S2 done** (evidence-correlated suggestions: T4→T3 join, ceiling/floor arithmetic over observed breach metrics). Next: P13-S3 `--apply` flag, or P13-S2.x secondary knobs. | Trust. Kills noise first; every later phase inherits this quality. |
